...
- **universal-gnss is a pinned submodule used only for public interfaces.** A bump means re-pinning the gitlink; never copy its runtime packages into a Mowgli workspace or image. The official external sidecar reference is release `v0.1.4-rc2`.
